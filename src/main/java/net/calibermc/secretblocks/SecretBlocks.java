...
//	public static final Block SECRET_LADDER = new SecretLadder(FabricBlockSettings.copy(SOLID_BLOCK));
	...
	public static final Block[] secretBlocksList = { GHOST_BLOCK, SOLID_BLOCK, STAIR_BLOCK, WOODEN_BUTTON, STONE_BUTTON, SECRET_LEVER, SECRET_OBSERVER, SECRET_DISPENSER, SECRET_HOPPER, SECRET_REDSTONE, SLAB_BLOCK, DOOR_BLOCK, IRON_DOOR_BLOCK, TRAPDOOR_BLOCK, IRON_TRAPDOOR_BLOCK };
//	public static final Block[] glassBlocksList = { SECRET_DISPENSER };
	public static final Block[] inventoryBlocksList = { SECRET_DISPENSER };


	public static final ItemGroup SECRET_BLOCKS_GROUP = FabricItemGroupBuilder.create(id("secret_blocks")).icon(() -> new ItemStack(SecretBlocks.CAMOUFLAGE_PASTE)).build();

	public static final Item CAMOLOCK_EYE = new Item(new Item.Settings().group(SECRET_BLOCKS_GROUP).rarity(Rarity.UNCOMMON));
	public static final Item SWITCH_PROBE = new SwitchProbe(new Item.Settings().group(SECRET_BLOCKS_GROUP).rarity(Rarity.RARE).maxCount(1));
	public static final Item SWITCH_PROBE_ROTATION_MODE = new SwitchProbe(new Item.Settings().group(SECRET_BLOCKS_GROUP).rarity(Rarity.RARE).maxCount(1));
	...
	public void onInitialize() {
		...
		SECRET_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, id("secret_block_entity_type"), FabricBlockEntityTypeBuilder.create(SecretBlockEntity::new, secretBlocksList).build());
...
//		Registry.register(Registry.ITEM, id("secret_ladder"), new BlockItem(SECRET_LADDER, new FabricItemSettings().group(SECRET_BLOCKS_GROUP)));
		...
		Registry.register(Registry.ITEM, id("switch_probe"), SWITCH_PROBE);

		Registry.register(Registry.ITEM, id("switch_probe_rotation_mode"), SWITCH_PROBE_ROTATION_MODE);
